    ...
    <div className="h-[70vh] flex flex-col">
      ...
      <div className="flex-1 grid grid-cols-5 gap-4 overflow-x-auto pb-4">
        {COLUMNS.map(column => {
          ...
          return (
            <div key={column} className="flex flex-col bg-zinc-900/40 border border-zinc-800/80 rounded-md overflow-hidden glass-panel">
              ...
              <div className="flex-1 p-3 space-y-3 overflow-y-auto">
                {colTasks.map((task: any) => {
                  ...
                  return (
                    <div key={task.id} className="bg-zinc-950/80 p-4 rounded-sm border border-zinc-800 hover:border-emerald-500/30 transition-colors">
                      {phase && (
