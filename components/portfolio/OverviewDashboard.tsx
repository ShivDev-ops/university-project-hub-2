  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-zinc-900/40 border border-zinc-800 rounded-2xl p-6 glass-panel">
        ...
        <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-6 glass-panel flex flex-col">
          ...
          <div className="space-y-3 mb-8 flex-1">
            {members.map((m: any) => (
              <div key={m.id} className="flex items-center gap-3 bg-zinc-950/50 p-3 rounded-lg border border-zinc-800/50">
      ...
      {judging && (
        <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-6 glass-panel">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-zinc-950/50 border border-zinc-800/50 p-6 rounded-xl relative">
