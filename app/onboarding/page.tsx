    ...
    <>
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { background-color: #09090b; color: #f4f4f5; overflow-x: hidden; font-family: 'Manrope', sans-serif; }
        .material-symbols-outlined { font-variation-settings: 'FILL' 0, 'wght' 400, 'GRAD' 0, 'opsz' 24; }
        .glass-panel { backdrop-filter: blur(20px); background: rgba(24,24,27,0.6); }
        .neon-glow { box-shadow: 0 0 20px rgba(16,185,129,0.2); }
        .neon-glow:hover { box-shadow: 0 0 30px rgba(16,185,129,0.4); }
        .mesh { background: radial-gradient(circle at 50% 50%, rgba(16,185,129,0.05) 0%, rgba(14,19,34,1) 70%); }
        .dots { background-image: radial-gradient(rgba(16,185,129,0.1) 1px, transparent 1px); background-size: 24px 24px; }
        .btn-primary {
          padding: 16px 32px;
          background: #10b981;
          color: #00285d;
      ...
      {/* Ambient glows */}
      <div style={{position:'fixed', top:'-10%', right:'-5%', width:'500px', height:'500px', background:'rgba(16,185,129,0.1)', borderRadius:'50%', filter:'blur(120px)', zIndex:-1}} />
      ...
      <main style={{minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:'24px 48px', position:'relative', overflow:'hidden'}}>
        ...
        <div style={{position:'absolute', bottom:'33%', right:'80px', width:'8px', height:'8px', background:'#10b981', borderRadius:'50%', opacity:0.3, boxShadow:'0 0 10px #10b981'}} />
        ...
        <div style={{maxWidth:'1100px', width:'100%', display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(300px, 1fr))', gap:'48px', alignItems:'center', position:'relative', zIndex:10}}>
          ...
          <section style={{display:'flex', flexDirection:'column', gap:'32px'}}>
            <div style={{display:'flex', flexDirection:'column', gap:'16px'}}>
              ...
              <h1 style={{fontFamily:'Inter', fontSize:'clamp(3rem, 6vw, 5rem)', fontWeight:800, lineHeight:1, letterSpacing:'-0.05em', color:'#f4f4f5'}}>
                Welcome <br />
              ...
              <p style={{fontSize:'18px', color:'#d4d4d8', maxWidth:'400px', fontWeight:300, lineHeight:1.6}}>
            ...
            <div style={{paddingTop:'32px', display:'flex', alignItems:'center', gap:'24px'}}>
              ...
              <p style={{fontFamily:'Inter', fontSize:'12px', color:'#71717a', fontStyle:'italic'}}>
          ...
          <div style={{position:'relative'}}>
            {/* Glow border */}
            <div style={{position:'absolute', inset:'-4px', background:'linear-gradient(to right, rgba(16,185,129,0.2), rgba(107,216,203,0.2), rgba(208,188,255,0.2))', borderRadius:'6px', filter:'blur(16px)', opacity:0.5}} />

            <div className="glass-panel" style={{position:'relative', border:'1px solid rgba(39,39,42,0.15)', borderRadius:'6px', overflow:'hidden', boxShadow:'0 25px 50px rgba(0,0,0,0.5)'}}>

              {/* Card Header */}
              <div style={{padding:'20px 24px', borderBottom:'1px solid rgba(39,39,42,0.1)', background:'rgba(37,41,58,0.4)', display:'flex', justifyContent:'space-between', alignItems:'center'}}>
              ...
              <div style={{padding:'32px', display:'flex', flexDirection:'column', gap:'32px'}}>
                ...
                <div style={{display:'flex', gap:'24px', alignItems:'flex-start'}}>
                  <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                    <div style={{width:'40px', height:'40px', borderRadius:'4px', background:'#18181b', border:'1px solid rgba(16,185,129,0.3)', display:'flex', alignItems:'center', justifyContent:'center', color:'#10b981', fontWeight:700, boxShadow:'0 0 15px rgba(16,185,129,0.1)', flexShrink:0}}>
                      01
                    </div>
                    <div style={{width:'1px', height:'48px', background:'linear-gradient(to bottom, rgba(16,185,129,0.3), transparent)', marginTop:'8px'}} />
                  </div>
                  <div style={{paddingTop:'4px'}}>
                    <h3 style={{fontFamily:'Space Grotesk', fontWeight:700, fontSize:'15px', color:'#f4f4f5', letterSpacing:'-0.02em', marginBottom:'4px'}}>
                      Add your skills
                    </h3>
                    ...
                    <div style={{display:'flex', gap:'8px', marginTop:'12px'}}>
                      <span style={{padding:'2px 8px', background:'rgba(16,185,129,0.1)', border:'1px solid rgba(16,185,129,0.2)', fontSize:'10px', color:'#10b981', textTransform:'uppercase', fontWeight:700, letterSpacing:'0.05em'}}>
                        Neural Nets
                      </span>
                ...
                <div style={{display:'flex', gap:'24px', alignItems:'flex-start'}}>
                  <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                    <div style={{width:'40px', height:'40px', borderRadius:'4px', background:'#18181b', border:'1px solid rgba(208,188,255,0.3)', display:'flex', alignItems:'center', justifyContent:'center', color:'#d0bcff', fontWeight:700, flexShrink:0}}>
                      02
                    </div>
                  ...
                  <div style={{paddingTop:'4px'}}>
                    ...
                    <div style={{marginTop:'12px', width:'100%', height:'6px', background:'#18181b', borderRadius:'999px', overflow:'hidden'}}>
                ...
                {/* Step 3 */}
                <div style={{display:'flex', gap:'24px', alignItems:'flex-start'}}>
                  <div style={{width:'40px', height:'40px', borderRadius:'4px', background:'#18181b', border:'1px solid rgba(107,216,203,0.3)', display:'flex', alignItems:'center', justifyContent:'center', color:'#6bd8cb', fontWeight:700, flexShrink:0}}>
                    03
                  </div>
                  <div style={{paddingTop:'4px'}}>
                    <h3 style={{fontFamily:'Space Grotesk', fontWeight:700, fontSize:'15px', color:'#f4f4f5', letterSpacing:'-0.02em', marginBottom:'4px'}}>
              ...
              <div style={{padding:'0 32px 32px'}}>
                <div style={{padding:'16px', background:'rgba(0,0,0,0.2)', border:'1px solid rgba(39,39,42,0.1)', borderRadius:'4px', position:'relative', overflow:'hidden'}}>
                  <div style={{display:'flex', justifyContent:'space-between', alignItems:'flex-end', position:'relative', zIndex:1}}>
                    <div>
                      <div style={{fontFamily:'DM Mono', fontSize:'9px', color:'#71717a', marginBottom:'4px'}}>DATA_STREAM_ID</div>
                      <div style={{fontFamily:'DM Mono', fontSize:'12px', color:'#10b981', fontWeight:700, letterSpacing:'-0.02em'}}>
                        882-X90-NS-ONBOARD
                      </div>
                    </div>
                    <div style={{display:'flex', gap:'4px', alignItems:'flex-end', height:'32px'}}>
                      {[60, 90, 40, 100, 70].map((h, i) => (
                        <div key={i} style={{width:'4px', background:`rgba(16,185,129,${0.4 + i * 0.1})`, height:`${h}%`}} />
                      ))}
                    </div>
                  </div>
                </div>
            ...
            {/* Floating chip */}
            <div className="glass-panel" style={{position:'absolute', bottom:'-24px', right:'-24px', border:'1px solid rgba(107,216,203,0.3)', padding:'16px', borderRadius:'4px', boxShadow:'0 25px 50px rgba(0,0,0,0.5)'}}>
              <div style={{display:'flex', alignItems:'center', gap:'16px'}}>
                ...
                <div>
                  <div style={{fontFamily:'DM Mono', fontSize:'10px', color:'#71717a', textTransform:'uppercase', fontWeight:700, letterSpacing:'0.1em'}}>
                    Efficiency
                  </div>
                  <div style={{fontFamily:'Inter', fontSize:'14px', fontWeight:800, color:'#f4f4f5'}}>
                    OPTIMAL
                  </div>
                </div>
              </div>
